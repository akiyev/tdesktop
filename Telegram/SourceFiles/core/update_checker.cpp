...
bool checkReadyUpdate() {
	...
	QFileInfo updater(cWorkingDir() + qsl("tupdates/temp/NebulaChat.app/Contents/Frameworks/Updater"));
...
QString countAlphaVersionSignature(uint64 version) { // duplicated in packer.cpp
	...
	QByteArray signedData = (qstr("NebulaChatBeta_") + QString::number(version, 16).toLower()).toUtf8();
