...
if (DESKTOP_APP_DISABLE_SPELLCHECK)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_SPELLCHECK)
else()
    target_link_libraries(NebulaChat PRIVATE desktop-app::lib_spellcheck)
endif()

if (disable_autoupdate)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_AUTOUPDATE)
endif()

if (DESKTOP_APP_SPECIAL_TARGET)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_ALLOW_CLOSED_ALPHA)
endif()

if (TDESKTOP_FORCE_GTK_FILE_DIALOG)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_FORCE_GTK_FILE_DIALOG)
endif()

if (TDESKTOP_DISABLE_REGISTER_CUSTOM_SCHEME)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_REGISTER_CUSTOM_SCHEME)
endif()

if (TDESKTOP_DISABLE_NETWORK_PROXY)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_NETWORK_PROXY)
endif()

if (TDESKTOP_DISABLE_DESKTOP_FILE_GENERATION)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_DESKTOP_FILE_GENERATION)
endif()

if (TDESKTOP_DISABLE_GTK_INTEGRATION)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_GTK_INTEGRATION)
endif()

if (TDESKTOP_DISABLE_DBUS_INTEGRATION)
    target_compile_definitions(NebulaChat PRIVATE TDESKTOP_DISABLE_DBUS_INTEGRATION)
endif()

if (NOT TDESKTOP_LAUNCHER_BASENAME)
    set(TDESKTOP_LAUNCHER_BASENAME "nebulachatdesktop")
endif()
target_compile_definitions(NebulaChat PRIVATE TDESKTOP_LAUNCHER_BASENAME=${TDESKTOP_LAUNCHER_BASENAME})
